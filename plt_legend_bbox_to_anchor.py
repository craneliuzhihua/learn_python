...
#apSyncQueryReq,=plt.plot(dates,apSyncQueryReq_req_nums,c='red',alpha=0.5,label='apSyncQueryReq')
#IntegratedSubscribeReq,=plt.plot(dates,IntegratedSubscribeReq_req_nums,c='blue',alpha=0.5,label='IntegratedSubscribeReq')
#plt.legend(handles=[apSyncQueryReq, IntegratedSubscribeReq],loc=6)
...
#plt.legend(bbox_to_anchor=(0., 1.02, 1., .102), loc=5,ncol=2, mode="expand", borderaxespad=0.)
plt.legend(bbox_to_anchor=(1,.102), loc=10,ncol=1, mode="expand", borderaxespad=0.)
